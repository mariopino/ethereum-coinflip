...
Coin Flip Ethereum DApp, a simple casino game based on Ethereum blockchain. Includes Solidity smart contract (CoinFlip.sol) and a bootstrap 4 / web3.js based web interface to interact with it.
